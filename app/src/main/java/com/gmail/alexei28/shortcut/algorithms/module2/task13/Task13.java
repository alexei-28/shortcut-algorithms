...
/*
    ...
    Пространственная сложность: O(1)
     ...
     - Важно:
       prev, current и next — это не новые списки и не копии данных. Это просто указатели (или ссылки), которые хранят адрес в памяти.
       Когда пишем prev = current, ты не создаем новый "ящик", мы просто переводим взгляд (указатель) с одного места на другое.
