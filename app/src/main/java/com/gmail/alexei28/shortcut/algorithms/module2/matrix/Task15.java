package com.gmail.alexei28.shortcut.algorithms.module2.matrix;
...
/*
    ...
    1. Временная сложность (Time Complexity): O(M * N)
      Общая временная сложность остается O(M * N), так как в худшем случае обходим матрицу фиксированное количество раз.
      1. Первый блок (проверка первой строки и колонки): обходиv только M + N элементов. Это занимает O(M + N).
