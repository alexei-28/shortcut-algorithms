...
Solution: [Task17.java](./app/src/main/java/com/gmail/alexei28/shortcut/algorithms/module2/task17/Task17.java)

Tests: [Task17Test.java](./app/src/test/java/com/gmail/alexei28/shortcut/algorithms/module2/task17/Task17Test.java)
...
Подсказка: Вычислите для каждого символа его позицию в строке-результате. 
Зигзаг состоит из вертикальных идущих вниз участков и диагональных идущих вверх. 
Можно вычислить индексы по формуле или создать массив строк и собрать результат.

Solution: [Task18.java](./app/src/main/java/com/gmail/alexei28/shortcut/algorithms/module2/Task18.java)

Tests: [Task18Test.java](./app/src/test/java/com/gmail/alexei28/shortcut/algorithms/module2/Task18Test.java)
...
Подсказка: Это расширение базового разворота списка (задание 13). Найдите узел перед позицией left,
разверните часть от left до right, затем аккуратно соедините развернутую часть с остальным списком.

Solution: [Task19.java](./app/src/main/java/com/gmail/alexei28/shortcut/algorithms/task19/Task19.java)

Tests: [Task19Test.java](./app/src/test/java/com/gmail/alexei28/shortcut/algorithms/task19/Task19Test.java)
...
Solution: [Task20.java](./app/src/main/java/com/gmail/alexei28/shortcut/algorithms/module2/task20/LinkedList.java)

Tests: [Task20Test.java](./app/src/test/java/com/gmail/alexei28/shortcut/algorithms/module2/task20/LinkedListTest.java)
